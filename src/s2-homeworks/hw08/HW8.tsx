...
const HW8 = () => {
  ...
  return (
    <div id={'hw3'} className={s2.hw1}>
      <div className={s2.hwTitle}>Case #8</div>
      <hr className={s2.hr} />
      <div className={s2.hw}>
        <div className={s.container}>
          ...
          <table id={'hw8-users'} className={s.users}>
            <thead className={s.thead}>
              <tr className={s.wrapCol}>
                <td className={s.nameCol}><strong> Full name</strong></td>
                <td className={s.ageCol}><strong>Age</strong></td>
              </tr>
            </thead>
